...
export function MobileMarketplaceNav({ user, isSessionLoading }: MobileMarketplaceNavProps) {
  ...
  const canReadOrders = isCustomer && user.permissions.includes(ORDERS_PERMISSION.READ_OWN);
